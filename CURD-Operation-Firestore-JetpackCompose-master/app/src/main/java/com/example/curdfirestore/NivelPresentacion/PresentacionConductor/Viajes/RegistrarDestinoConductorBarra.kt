...
println("Valor mapa antes barra= $valorMapa")
                        println("Valor TipoBusques antes barra= $TipoBusqueda")
                    ...
                    if(primeraVez==0){
                        pasarlatitud="19.389816"
                        pasarlongitud="-99.110234"
                    }

                    println("YA cambiando a marker $pasarlatitud, $pasarlongitud")
                    ubiMarker= mapaMarkerDestino(ubicacionMarker ="$pasarlatitud,$pasarlongitud" )
